...
import 'package:login_screen/widget/custom_snk.dart';
...
//     }
  ...
  Future<void> signUp(BuildContext context) async {
    ...
    try {
      ...
      Userdata userData = Userdata(name: t1.text, email: t2.text, pwd: t3.text);

      // Convert the model to JSON
      String jsonPayload = json.encode(userData.toJson());
      ...
      if (response.statusCode == 200) {
        ...
        coustomSnk(context: context, text: "Register successful");

      } else {
        // Error response
        print('Error: ${response.statusCode}');
        coustomSnk(context: context, text: "Something Wrong");
      }
    } catch (error) {
      // Handle the error
      print('Error: $error');
